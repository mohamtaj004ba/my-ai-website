...
document.getElementById('modalCta')?.addEventListener('click',()=>alert('Plan changes will be handled through Stripe once subscription-management configuration is enabled.'));
