...
function renderDocuments(){
  ...
  const reviewCount=company.filter(x=>['review','expired'].includes(x.status)||(x.expiresAt&&new Date(x.expiresAt+'T12:00:00').getTime()<Date.now())).length;
