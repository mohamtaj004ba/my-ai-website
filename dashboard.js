...
function renderAgent(){
  ...
  const test=document.getElementById('agentTestCall'),digits=String(phoneRoutingData?.number||'').replace(/\D/g,'');if(test){test.hidden=!digits;test.href=digits?'tel:'+digits:'#';test.title=digits?'Call '+phoneRoutingData.number+' to test '+(agentData.name||'Maya'):''}
