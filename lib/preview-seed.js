...
const CALL_SCENARIOS=[
  ...
  {category:'Billing',reason:'Requesting a receipt or invoice copy',outcome:'Resolved',disposition:'resolved_by_ai',weight:2},
...
function makePrimaryDataset(){
  ...
  for(let day=0;day<60;day++){
    ...
    for(let j=0;j<daily;j++){
      ...
      let person=nameFor(customerIndex),reason=scenario.reason,category=scenario.category;
