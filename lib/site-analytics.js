...
return 1
`;
function nextStage(raw,old){return clean(raw.stage!==undefined?raw.stage:old.stage,60)||'new'}
async function upsertWebsiteProspectAttempt(raw={}){
  ...
  const next={...old,id,
    ...
    stage:old.stage==='converted'&&raw.stage!=='converted'?'converted':nextStage(raw,old),
